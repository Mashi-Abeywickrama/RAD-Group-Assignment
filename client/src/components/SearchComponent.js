    ...
    return(
        ...
        <div className="row">
            <div className="col-12 heading">
             <h2 align="center">Search books here... </h2><br></br>
             <Form>
        <Row form>
          <Col md={6}>
            <FormGroup>
              <Label for="name"><b>Name of book</b></Label>
              <Input type="name" name="name" id="name" value={this.state.name} onChange={(e)=>{this.setState({name: e.target.value});}} placeholder="Book Name" />
            </FormGroup>
          </Col>
          <Col md={6}>
            <FormGroup>
              <Label for="author"><b>Author</b></Label>
              <Input type="author" name="author" id="author" value={this.state.author}  onChange={(e)=>{this.setState({author: e.target.value});}} placeholder="Author's name" />
            </FormGroup>
          </Col>
        </Row> 
        <Row>
