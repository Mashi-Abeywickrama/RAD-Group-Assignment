...
class Header extends Component{
  ...
  handleLogout() {
    ...
    render(){
        return (
            <React.Fragment>
                 <Navbar className='navbar navbar-expand-sm bg-light justify-content-center' dark expand="xl" fixed="top">
                     ...
                     <Nav navbar>
                        ...
                        {this.props.auth.userinfo&&this.props.auth.userinfo.admin?(
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownItem onClick={this.toggleNav} tag={Link} to="/add_book" >Add books</DropdownItem>
                            </DropdownMenu>
                          </Dropdown>
                          </NavItem>
                        ):(
                            ...
                            (this.props.auth.isAuthenticated&&this.props.auth.userinfo.admin)?(
                              <React.Fragment>
                                ...
                                <NavLink className="nav-link text-primary" to="/issue">
                                     <span className="fa fa-plus-square"/> Issue Books
                                </NavLink>
                                </NavItem>
                                <NavItem onClick={this.toggleNav} className="ml-2">
                                <NavLink className="nav-link text-primary" to="/return">
                                   <span className="fa fa-list-ul"/> Return Books
                                </NavLink>
                                </NavItem>
                                <NavItem onClick={this.toggleNav} className="ml-2">
                     ...
                     <NavItem>
                        ...
                        <Button outline color="primary" onClick={this.toggleModal}>
                                        ...
                                        <div className='justify-items'>
                                            <div className="navbar-text text-primary mr-3">{this.props.auth.user.username}</div>
                                            <Button outline color="dark" onClick={this.handleLogout}>
